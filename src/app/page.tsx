...
export default function HomePage() {
  ...
  return (
    <main className="min-h-screen bg-black text-white selection:bg-white selection:text-black pt-24 pb-20">
      ...
      <section className="relative px-6 md:px-12 max-w-7xl mx-auto mb-32 pt-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-end">
          ...
          <div className="lg:col-span-8">
            ...
            {/* Adjusted mobile font size to prevent overflow */}
          ...
          {/* Right: Technical Console (Hidden on small mobile for clean design) */}
      ...
      {/* 2. CORE SYSTEMS GRID (Replaces Venture Desk) */}
        ...
        <div className="border-t border-white/10 pt-12">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-px bg-white/10 border border-white/10">
            {projects.map((project, idx) => (
              <a href="/projects" key={idx} className="group bg-black p-8 hover:bg-white/5 transition-colors flex flex-col justify-between min-h-[200px]">
                <div>
                ...
                <div className="text-neutral-700 font-mono text-xs opacity-0 group-hover:opacity-100 transition-opacity translate-y-2 group-hover:translate-y-0 duration-300">
                  [ Inspect ]
                </div>
              </a>
            ))}
